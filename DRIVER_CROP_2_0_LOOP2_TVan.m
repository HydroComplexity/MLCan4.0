...
for Y = 1:numyearstoloop
    ...
    forcinglocation = 'D:\Users\Meredith\From Lyra\MLCan_MeredithEdits_working\MLCan4.0\Data\Niwot Ridge\TVan_alpine\6yr_run_forcing\'; % add your file location here
    forcingfile = 'TVan_6yr_Forcing_';
    sitestr = '.TVan_';
    sitestr2 = 'TVan_';
%     mtemp.fullpath_forcings = strcat(forcinglocation,forcingfile,num2str(Y));
    ...
    %     mtemp = matfile(tempfilename, 'Writable', true); %N
        ...
        forcinglocationshort = '.\Data\Niwot Ridge\TVan_alpine\6yr_run_forcing\';
...
PARAMS.Photosyn.ph_minT = -7;%-15;
PARAMS.Photosyn.ph_restartT = 3;% -5;
...
PARAMS.refl_NIR_can_snow = 0.2;%0.25;%0.275;        %  95-mixforest or trans wood/shrub,mineral land;110-mixfor,peat;150-conif,peat
