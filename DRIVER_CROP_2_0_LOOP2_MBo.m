...
for Y = 1:numyearstoloop
    ...
    forcinglocation = 'D:\Users\Meredith\From Lyra\MLCan_MeredithEdits_working\MLCan4.0\Data\Italy\MBo_Alpine\2yr_run_forcing\'; % add your file location here
    forcingfile = 'MBo_2yr_Forcing_';
    sitestr = '.MBo_';
    sitestr2 = 'MBo_';
%     mtemp.fullpath_forcings = strcat(forcinglocation,forcingfile,num2str(Y));
    ...
    %     mtemp = matfile(tempfilename, 'Writable', true); %N
        ...
        forcinglocationshort = '.\Data\Italy\MBo_Alpine\2yr_run_forcing\';
...
PARAMS.refl_PAR_can_snow = 0.15;
PARAMS.refl_NIR_can_snow = 0.3;        %  95-mixforest or trans wood/shrub,mineral land;110-mixfor,peat;150-conif,peat
