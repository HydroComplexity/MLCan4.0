...
for Y = 1:numyearstoloop
    ...
    forcinglocation = 'D:\Users\Meredith\From Lyra\MLCan_MeredithEdits_working\MLCan4.0\Data\Niwot Ridge\NR1_subalpine\6yr_run_forcing\'; % add your file location here
...
%     mtemp.fullpath_forcings = strcat(forcinglocation,forcingfile,num2str(Y));
    ...
    %     mtemp = matfile(tempfilename, 'Writable', true); %N
        ...
        forcinglocationshort = '.\Data\Niwot Ridge\NR1_subalpine\6yr_run_forcing\';
...
PARAMS.refl_NIR_can_snow = 0.07;%0.1;%0.2;        %  95-mixforest or trans wood/shrub,mineral land;110-mixfor,peat;150-conif,peat
