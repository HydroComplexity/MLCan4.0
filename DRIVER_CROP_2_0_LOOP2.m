...
for Y = 1:numyearstoloop
    ...
    forcinglocation = 'D:\Users\Meredith\MLCan_MeredithEdits_working\MLCan3.0\Data\Konza\KON\10_yr_run_forcing\'; % add your file location here
    forcingfile = 'KON_10yr_Forcing_'; % the forcing files should have a naming convention that ends in a number corresponding to the order you want to call them in (i.e. 1, 2, 3,...,65,..., etc.)
%     mtemp.fullpath_forcings = strcat(forcinglocation,forcingfile,num2str(Y));
    ...
    %     mtemp = matfile(tempfilename, 'Writable', true); %N
        ...
        forcinglocationshort = '.\Data\Konza\KON\10_yr_run_forcing\';
