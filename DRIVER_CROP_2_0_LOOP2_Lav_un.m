...
for Y = 1:numyearstoloop
    ...
    forcinglocation = 'D:\Users\Meredith\From Lyra\MLCan_MeredithEdits_working\MLCan4.0\Data\Italy\Lav_Subalpine\2yr_run_forcing\'; % add your file location here
    forcingfile = 'Lav_3yr_Forcing_'; % the forcing files should have a naming convention that ends in a number corresponding to the order you want to call them in (i.e. 1, 2, 3,...,65,..., etc.)
    sitestr = '.Lav_un_';
    sitestr2 = 'Lav_un_';
%     mtemp.fullpath_forcings = strcat(forcinglocation,forcingfile,num2str(Y));
    ...
    %     mtemp = matfile(tempfilename, 'Writable', true); %N
        ...
        forcinglocationshort = '.\Data\Italy\Lav_Subalpine\2yr_run_forcing\';
...
PARAMS.inv_hobs = 36; PARAMS.inv_hcan = 7.2; %[m]
