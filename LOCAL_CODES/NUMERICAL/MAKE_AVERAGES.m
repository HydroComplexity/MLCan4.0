% CALCULATE DIURNAL AVERAGES
    ...
    [LE_diurnal_med_eco, LE_iqr_eco] = DIURNAL_MEDIAN (hr, hour, LE_eco_store);
    [H_diurnal_med_eco, H_iqr_eco] = DIURNAL_MEDIAN (hr, hour, H_eco_store);
    ...
    [Tsurf_diurnal_mod, Tsurf_std_mod] = DIURNAL_AVERAGE (hr, hour, Tsurf_store); 
    [Ts1_diurnal_mod, Ts1_std_mod] = DIURNAL_AVERAGE (hr, hour, Ts_store(1,:));
    [Ts2_diurnal_mod, Ts2_std_mod] = DIURNAL_AVERAGE (hr, hour, Ts_store(2,:));
    [Ts5_diurnal_mod, Ts5_std_mod] = DIURNAL_AVERAGE (hr, hour, Ts_store(5,:));
    [Ts8_diurnal_mod, Ts8_std_mod] = DIURNAL_AVERAGE (hr, hour, Ts_store(8,:));
