...
% Last Updated: Meredith Richardson, November 2018
% All rights reserved!
%
%------------------------- Input Variables -------------------------------
...
%*************************************************************************
    ...
    %**********************************************************************
    if (sunlit)
        An =  VARIABLES.CANOPY.An_sun(:,cntspecies);                       % [umol/m^2 la/s] An - net CO2 uptake Sunlit Fraction     
...
%         Ciprev =  VARIABLES.CANOPY.Ci_sun(:,cntspecies);                       % [umol/mol] Internal leaf concentration of CO2 in previous time step
        ...
        An =  VARIABLES.CANOPY.An_shade(:,cntspecies);                     % [umol/m^2 la/s] An - net CO2 uptake Shaded Fraction  
...
%         Ciprev =  VARIABLES.CANOPY.Ci_shade(:,cntspecies);                       % [umol/mol] Internal leaf concentration of CO2 in previous time step
    end
    ...
    Ca = VARIABLES.CANOPY.CAz;                                             % [umol/mol] Atmospheric concentration of CO2  
