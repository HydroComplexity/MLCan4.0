   ...
   while (max(converge) > 0.1) %1e-20  
       cnt = cnt+1;
        ...
        [dwat,smp,kboundary,klayer,ft,fb,qlayer,layeruptake,layeruptake_all,mberrormm,type,hor_drainage,hor_drainage_lay,flux_Ss] ...
            = soilmodel(SWITCHES, VARIABLES, nl_soil,dtime,effporsl,phi0,bsw,hksati,zmm',dzmm',zimm',wliq,plants,rpp,krad,...
            pthr,nspecies, type, n, alpha, thetar,vanGen, theta_dry);
