function [remain, LEs, Gsl, Gs, Tlb] = SEB_Remainder_soil3G(Tl, Ts1,...
                                   zsl, TK_litter, dzs1, TC1, Rabs, Gobs)
...
%     Gsl = (TK_litter)*(Tl - Tlb)/((zsl)/2);  %Mere G_obs;
% 
%     Gs = (TC1)*(Tlb - Ts1)/((dzs1)/2);  %Mere G_obs;
