...
%*************************************************************************
    ...
    TC1 = VARIABLES.SOIL.TKsoil(1);                                         %[W / m / K] Thermal Conductivity first soil layer    
...
while abs(dif) > 0.005
       ...
       [remain1, Hl, LEl, Gsl, ra, LWups] = SEB_Remainder_snowG(Tli, Tsl, Tlprev, VHC_SL, dtime,...
                                   Rabs, dH, Ta1, ea1, pa1, U1, z1,...
                                   vonk, z0, epss, zsl_m, TK_sl,...
                                   rho_dry_air, cp, Lv, Lf, boltz, thetamin, Gobs); %Mere );                                  
        ...
        Tli = fzero(@(Tli) SEB_Remainder_snowG(Tli, Tsl, Tlprev, VHC_SL, dtime,...
                                   Rabs, dH, Ta1, ea1, pa1, U1, z1,...
                                   vonk, z0, epss, zsl_m, TK_sl,...
                                   rho_dry_air, cp, Lv, Lf, boltz, thetamin, Gobs), Ta1);
...
%        end
        ...
        [remain2, LEs, Gsl, Gs, Tsl] = SEB_Remainder_soil3G(Tli, Ts1,...
                 zsl_m, TK_sl, dzs1, TC1, Af2*Rabs, Gobs);                 
