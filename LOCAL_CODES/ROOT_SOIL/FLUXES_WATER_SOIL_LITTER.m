...
%========================================================================
    ...
    if case1sl == 1        
        Esl_ice = LEsl / Ls_kg * (1000/rho_ice);                           %[mm ice / s]Sublimation From Snow-Litter Pack 
        Esl = Esl_ice;
        Esl_liq = 0;
    else
        Esl_ice = 0;                  
        Esl_liq = LEsl / (Lv_kg) * (1000/rho_liq);                         %[mm liq / s] Evaporation From Snow-Litter Pack 
        Esl = Esl_liq;
    end 
...
%    zliqsl_new = max(0,zliqsl_new);                                               %[mm liq]
    ...
    % The final snow density is computed by a mass weighted average of the
