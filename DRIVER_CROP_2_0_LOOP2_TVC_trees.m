...
for Y = 1:numyearstoloop
    ...
    forcinglocation = 'D:\Users\Meredith\From Lyra\MLCan_MeredithEdits_working\MLCan4.0\Data\Arctic\TVCarctic\3yr_run_forcing_trees\'; % add your file location here
    forcingfile = 'TVC_Forcing_trees_'; % the forcing files should have a naming convention that ends in a number corresponding to the order you want to call them in (i.e. 1, 2, 3,...,65,..., etc.)
    sitestr = '.TVC_trees_';
    sitestr2 = 'TVC_trees_';
%     mtemp.fullpath_forcings = strcat(forcinglocation,forcingfile,num2str(Y));
    ...
    %     mtemp = matfile(tempfilename, 'Writable', true); %N
        ...
        forcinglocationshort = '.\Data\Arctic\TVCarctic\3yr_run_forcing_trees\';
...
PARAMS.refl_NIR_can_snow = 0.4;%0.225;        %  95-mixforest or trans wood/shrub,mineral land;110-mixfor,peat;150-conif,peat
...
namefileout2 = ['./Result/Treeline Analysis/Arctic/',sitestr2,num2str(2015+Y),'.mat'];
