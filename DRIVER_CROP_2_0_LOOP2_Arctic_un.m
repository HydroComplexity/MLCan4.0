...
for Y = 1:numyearstoloop
    ...
    forcinglocation = 'D:\Users\Meredith\From Lyra\MLCan_MeredithEdits_working\MLCan4.0\Data\Arctic\HPCsubarctic\3yr_run_forcing_nospin\'; % add your file location here
    forcingfile = 'HPC_3yr_Forcing_';
    sitestr = '.HPC_un_';
    sitestr2 = 'HPC_un_';
%     mtemp.fullpath_forcings = strcat(forcinglocation,forcingfile,num2str(Y));
    ...
    %     mtemp = matfile(tempfilename, 'Writable', true); %N
        ...
        forcinglocationshort = '.\Data\Arctic\HPCsubarctic\3yr_run_forcing_nospin\';
...
PARAMS.inv_hobs = 15; PARAMS.inv_hcan = 1.3; %[m]
