...
for Y = 1:numyearstoloop
    ...
    forcinglocation = 'D:\Users\Meredith\From Lyra\MLCan_MeredithEdits_working\MLCan4.0\Data\Niwot Ridge\TVan_alpine\6yr_run_forcing_trees\'; % add your file location here
    forcingfile = 'TVan_trees_6yr_Forcing_';
    sitestr = '.TVan_trees_';
    sitestr2 = 'TVan_trees_';
%     mtemp.fullpath_forcings = strcat(forcinglocation,forcingfile,num2str(Y));
    ...
    %     mtemp = matfile(tempfilename, 'Writable', true); %N
        ...
        forcinglocationshort = '.\Data\Niwot Ridge\TVan_alpine\6yr_run_forcing_trees\';
...
PARAMS.refl_PAR_can_snow = 0.07;%0.1;
PARAMS.refl_NIR_can_snow = 0.1;%0.2;        %  95-mixforest or trans wood/shrub,mineral land;110-mixfor,peat;150-conif,peat
...
PARAMS.inv_hobs = 3; PARAMS.inv_hcan = 0.05; %[m]
PARAMS.true_hcan = 12;% PARAMS.inv_hcan;
...
%         '_IC_NR1_', num2str(Y),'.mat'];
    namefilein = ['./Result' '/Result_IC_TVan.mat'];
end
